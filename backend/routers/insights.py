        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "\n\nCRITICAL DATA RULES:"
                    "\n- If a metric value is 0.0 or not provided, do NOT mention it. Zero values mean the data is unavailable, not that the metric is actually zero."
                    "\n- Never mention D7 retention, D30 retention, or any retention rate unless the value is explicitly greater than 0 in the data provided."
                    "\n- Never invent or assume metric values. Only use what is in the data."
